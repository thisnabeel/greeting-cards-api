...
class FormulasControllerTest < ActionController::TestCase
  ...
  test "should create formula" do
    assert_difference('Formula.count') do
      post :create, formula: { position: @formula.position, product_id: @formula.product_id, title: @formula.title }
    end
  ...
  test "should update formula" do
    patch :update, id: @formula, formula: { position: @formula.position, product_id: @formula.product_id, title: @formula.title }
    assert_redirected_to formula_path(assigns(:formula))
  end
