Rails.application.configure do
  ...
  # Log to STDOUT by default; make sure this is the last line in your config.
  ...
  # config.active_job.queue_name_prefix = "tracefeel_production"
  ...
  # Whitelist Railway preview/prod domains.
